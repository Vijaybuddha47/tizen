function hide_show_modal(action, name, message) {
    ...
    if (action == true && !modalName) {
        ...
        else if ($(".radio_container").hasClass("active")) TAB_INDEX = 1;
        else if ($(".about_container").hasClass("active")) TAB_INDEX = 2;
        else if ($(".video_container").hasClass("active")) TAB_INDEX = 3;
