function manage_spatial_navigation(containerClass, favoriteStatus, vodId) {
    switch (containerClass) {
        case "menu_container":
            ...
            $('#menuList').on('sn:enter-down', function (e) {
                ...
                if (localStorage.getItem("days_left") == "0" && MENU_INDEX <= 4) {
                    ...
                    $(".modal_sub_all").show();
                    // $(".home_container").hide();
                    // $(".content_partner_container").hide();
                    // $(".account_container").hide();
                    // $(".watch_ppv_container").hide();
                    // $(".redeem_ppv_container").hide();
                    $("#loader").hide();
                    SN.focus("okModal");
                } else {
                    selected_menu_data();
        ...
        case "redeem_ppv_container":
            set_focus('redeem_code_container', 'search_input');
        ...
        case "account_container":
            ...
            $('#account_buy_subscription').on('sn:enter-down', function (e) {
                console.log("account_exit enter...");
                hide_show_modal(true, 'EXIT', APP_SHOW_QR_MSG);
        ...
        case "EXIT":
            ...
            $('#noButton').on('sn:enter-down', function (e) {
                ...
                if ($(".modal_container").hasClass("active") && MENU_INDEX !== 8 && name == "EXIT") {
                ...
                } else if ($(".modal_container").hasClass("active") && MENU_INDEX == 8 && name == "EXIT") {
        ...
        case "LOGOUT": set_focus('exitModal', 'noButton');
            ...
            $('#noButton').on('sn:enter-down', function (e) {
                var name = $(".modal_container").attr("data-modal-name");
                console.log('hide popup');
                if ($(".modal_container").hasClass("active") && MENU_INDEX == 8 && name == "LOGOUT") {
...
function set_watch_ppv_list_focus(row_num) {
    ...
    $('[id^=watch_ppv_]').on('sn:enter-down', function (e) {
        ...
        if (SELECTED_ITEM_DATA["buy_status"] == 'N' && SELECTED_ITEM_DATA["ppv_code"] == '0') {
            $(".modal_subscription").show();
            SN.focus("okModal");
        } else if (SELECTED_ITEM_DATA["buy_status"] == 'Y' && SELECTED_ITEM_DATA["ppv_code"] != '0') {
            getPPVContentDetail();
        }
