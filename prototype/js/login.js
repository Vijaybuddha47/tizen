    ...
    case "login-container":
      ...
      $("#loginButton").on("sn:enter-down", function (e) {
        ...
        if (email == "") {
          ...
          localStorage.setItem("prototype_email", email);
          localStorage.setItem("prototype_password", password);
          signinApi();
        }
      });
      ...
      $("#signUpButton").on("sn:enter-down", function (e) {
        ...
        SN.focus("sign_up_container");
      });
      break;

    case "signup-container":
      set_focus("sign_up_container", "username");

      $("#sign_up_container").on("sn:focused", function (e) {
      ...
      $("#sign_UpButton").on("sn:enter-down", function (e) {
        ...
        if (signupUsername == "" || signupEmail == "" || signupPassword == "") {
          var msg = "";
          if (signupUsername == "") msg = "Enter the usernamel.";
      ...
      $("#cancelSignButton").on("sn:enter-down", function (e) {
        $("#sign_up_container").hide();
        $("#login_container").show();
        SN.focus("#signUpButton");
        $("input").val("");
