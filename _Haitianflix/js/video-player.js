...
var closeVideo = function () {
	...
	if (PAGE_INDEX == 12) SN.focus("#play_now_button");
	else if (PAGE_INDEX == 10) SN.focus("detail_container");
	else if (PAGE_INDEX == 7) SN.focus("#" + FIRST_PAGE_FOCUSED_ITEM);
	$(".pause-icon").hide();
