window.APP_NAME = "Tizen weight losss";
//projects.fusionitechnologies.com/fusioni-proto/public/api/v1/register
window.APP_DOMAIN =
  "http://34.225.204.47/api";

//All global array
window.HOME_DATA_ARRAY = {};
window.SEARCH_DATA_ARRAY = {};
window.SHOW_DATA_ARRAY = {};
window.MOVIE_DATA_ARRAY = {};
window.SEASON_DATA_ARRAY = {};
window.EPISODES_DATA_ARRAY = {};
window.SEARCH_DATA_ARRAY = {};
window.FAVOURITE_DATA_ARRAY = {};
window.SELECTED_ITEM_DATA = {};
window.DETAILS_DATA_ARRAY = {};

//Common variables used in app
window.FIRST_PAGE_FOCUSED_ITEM = '';
window.SELECTED_MENU = "home";
window.SHOW_FOCUSED_ITEM = "item_0_0";
window.LAST_FOCUSED_ITEM = "item_0_0";
